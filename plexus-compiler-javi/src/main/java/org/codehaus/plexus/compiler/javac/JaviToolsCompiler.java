...
public class JaviToolsCompiler implements InProcessCompiler
{
    /**
     * is that thread safe ???
     */
    ...
    {
        for (JavaCompiler javaCompiler : ServiceLoader.load(JavaCompiler.class, JaviToolsCompiler.class.getClassLoader())) {
            return javaCompiler;
        }
        throw new UnsupportedOperationException("can't find compiler");
    }
