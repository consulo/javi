...
import javi.compiler.internal.com.sun.tools.javac.file.CacheFSInfo;
...
import javi.compiler.internal.com.sun.tools.javac.util.PropagatedException;
 ...
 */
public class JavacTool implements javi.api.tools.JavaCompiler {
    /**
     ...
     * @see javi.api.tools.JavaCompiler
     * @see ToolProvider
     * @see #create
     */
    @Deprecated
    ...
    public JavacFileManager getStandardFileManager(
        javi.api.tools.DiagnosticListener<? super javi.api.tools.JavaFileObject> diagnosticListener,
        Locale locale,
        Charset charset) {
        Context context = new Context();
        context.put(Locale.class, locale);
        if (diagnosticListener != null)
            context.put(javi.api.tools.DiagnosticListener.class, diagnosticListener);
    ...
    public JavacTask getTask(Writer out,
                             ...
                             Iterable<? extends javi.api.tools.JavaFileObject> compilationUnits) {
        Context context = new Context();
                             ...
                             Context context)
    {
        try {
            ...
            if (compilationUnits != null) {
                ...
                for (javi.api.tools.JavaFileObject cu : compilationUnits) {
                    if (cu.getKind() != javi.api.tools.JavaFileObject.Kind.SOURCE) {
            ...
            if (diagnosticListener != null)
                context.put(javi.api.tools.DiagnosticListener.class, ccw.wrap(diagnosticListener));
            ...
            context.put(javi.api.tools.JavaFileManager.class, fileManager);
    ...
    public int run(InputStream in, OutputStream out, OutputStream err, String... arguments) {
        ...
        return javi.compiler.internal.com.sun.tools.javac.Main.compile(arguments, new PrintWriter(err, true));
    }
