...
import javi.compiler.internal.annotation.ExceptionProxy;

import javi.api.lang.model.type.MirroredTypeException;
import javi.api.lang.model.type.MirroredTypesException;
...
public class AnnotationProxyMaker {
    ...
    private Annotation generateAnnotation() {
        return javi.compiler.internal.annotation.AnnotationParser.annotationForMap(annoType,
    ...
    private class ValueVisitor implements Attribute.Visitor {
        ...
        Object getValue(Attribute attr) {
            ...
            attr.accept(this);
            if (!(value instanceof javi.compiler.internal.annotation.ExceptionProxy) &&
                !javi.compiler.internal.annotation.AnnotationType.invocationHandlerReturnType(returnClass)
                                                        .isInstance(value)) {
            ...
            if (elemName.equals(elemName.table.names.java_lang_Class)) {   // Class[]
                ...
                try {
                    ...
                    for (int i = 0; i < len; i++) {
                        ...
                        if (value == null || value instanceof javi.compiler.internal.annotation.ExceptionProxy) {
                            return;
                        }
                        try {
        ...
        public void visitEnum(Attribute.Enum e) {
            if (returnClass.isEnum()) {
                ...
                try {
                    ...
                    value = new javi.compiler.internal.annotation.EnumConstantNotPresentExceptionProxy(
        ...
        private void typeMismatch(Method method, final Attribute attr) {
            class AnnotationTypeMismatchExceptionProxy extends javi.compiler.internal.annotation.ExceptionProxy {
     ...
     * type.
     */
    private static final class MirroredTypeExceptionProxy extends javi.compiler.internal.annotation.ExceptionProxy {
        static final long serialVersionUID = 269;
