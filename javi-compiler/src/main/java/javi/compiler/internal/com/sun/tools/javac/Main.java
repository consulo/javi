...
package javi.compiler.internal.com.sun.tools.javac;
...
public class Main {
    ...
    public static int compile(String[] args) {
        javi.compiler.internal.com.sun.tools.javac.main.Main compiler =
            new javi.compiler.internal.com.sun.tools.javac.main.Main("javac");
    ...
    public static int compile(String[] args, PrintWriter out) {
        javi.compiler.internal.com.sun.tools.javac.main.Main compiler =
            new javi.compiler.internal.com.sun.tools.javac.main.Main("javac", out);
        return compiler.compile(args).exitCode;
    }
}
