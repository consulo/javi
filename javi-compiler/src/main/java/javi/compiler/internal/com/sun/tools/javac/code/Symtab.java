        ...
        unnamedModule = new ModuleSymbol(names.empty, null) {
                {
                    ...
                    javi.compiler.internal.com.sun.tools.javac.code.Directive.RequiresDirective d =
                            new javi.compiler.internal.com.sun.tools.javac.code.Directive.RequiresDirective(java_base,
                                    EnumSet.of(javi.compiler.internal.com.sun.tools.javac.code.Directive.RequiresFlag.MANDATED));
                    requires = List.of(d);
                }
                @Override
