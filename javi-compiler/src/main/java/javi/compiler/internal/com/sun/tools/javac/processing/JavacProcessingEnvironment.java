 ...
 */
public class JavacProcessingEnvironment implements javi.api.annotation.processing.ProcessingEnvironment, Closeable {
    ...
    private ServiceLoader<javi.api.annotation.processing.Processor> serviceLoader;
    ...
    public void setProcessors(Iterable<? extends javi.api.annotation.processing.Processor> processors) {
    ...
    private void initProcessorLoader() {
        try {
            if (fileManager.hasLocation(ANNOTATION_PROCESSOR_MODULE_PATH)) {
                try {
                    serviceLoader = fileManager.getServiceLoader(ANNOTATION_PROCESSOR_MODULE_PATH, javi.api.annotation.processing.Processor.class);
                } catch (IOException e) {
                    throw new Abort(e);
                }
            } else {
    ...
    private void initProcessorIterator(Iterable<? extends javi.api.annotation.processing.Processor> processors) {
        Iterator<? extends javi.api.annotation.processing.Processor> processorIterator;
        ...
        java.util.List<javi.api.annotation.processing.Processor> platformProcessors = Collections.emptyList();
        ...
        List<Iterator<? extends javi.api.annotation.processing.Processor>> iterators = List.of(processorIterator,
                                                                platformProcessors.iterator());
        Iterator<? extends javi.api.annotation.processing.Processor> compoundIterator =
     ...
     */
    private Iterator<javi.api.annotation.processing.Processor> handleServiceLoaderUnavailability(String key, Exception e) {
        ...
        java.util.List<javi.api.annotation.processing.Processor> pl = Collections.emptyList();
        return pl.iterator();
    }
     ...
     */
    private class ServiceIterator implements Iterator<javi.api.annotation.processing.Processor> {
        Iterator<javi.api.annotation.processing.Processor> iterator;
        Log log;
        ServiceLoader<javi.api.annotation.processing.Processor> loader;

        ServiceIterator(ClassLoader classLoader, Log log) {
            this.log = log;
            try {
                try {
                    loader = ServiceLoader.load(javi.api.annotation.processing.Processor.class, classLoader);
        ...
        ServiceIterator(ServiceLoader<javi.api.annotation.processing.Processor> loader, Log log) {
            this.log = log;
            this.loader = loader;
            this.iterator = loader.iterator();
        }
        ...
        @Override
        public javi.api.annotation.processing.Processor next() {
            try {
                return internalNext();
            } catch (ServiceConfigurationError sce) {
                log.error(Errors.ProcBadConfigFile(sce.getLocalizedMessage()));
        ...
        javi.api.annotation.processing.Processor internalNext() {
    ...
    private class NameServiceIterator extends ServiceIterator {
        private Map<String, javi.api.annotation.processing.Processor> namedProcessorsMap = new HashMap<>();;
        private Iterator<String> processorNames = null;
        private javi.api.annotation.processing.Processor nextProc = null;

        public NameServiceIterator(ServiceLoader<javi.api.annotation.processing.Processor> loader, Log log, String theNames) {
            super(loader, log);
        ...
        boolean internalHasNext() {
            ...
            javi.api.annotation.processing.Processor theProcessor = namedProcessorsMap.get(processorName);
        ...
        javi.api.annotation.processing.Processor internalNext() {
            if (hasNext()) {
                javi.api.annotation.processing.Processor p = nextProc;
                nextProc = null;
                return p;
            } else {
    ...
    private static class NameProcessIterator implements Iterator<javi.api.annotation.processing.Processor> {
        javi.api.annotation.processing.Processor nextProc = null;
        ...
        public boolean hasNext() {
            if (nextProc != null)
                ...
                if (!names.hasNext()) {
                    ...
                    javi.api.annotation.processing.Processor processor = getNextProcessor(names.next());
                    if (processor == null) {
                        return false;
                    } else {
                        nextProc = processor;
        ...
        private javi.api.annotation.processing.Processor getNextProcessor(String processorName) {
            try {
                try {
                    Class<?> processorClass = processorCL.loadClass(processorName);
                    ensureReadable(processorClass);
                    return (javi.api.annotation.processing.Processor) processorClass.getConstructor().newInstance();
    ...
    private Map<String, String> initProcessorOptions() {
        ...
        if (platformProvider != null) {
            for (PluginInfo<javi.api.annotation.processing.Processor> ap : platformProvider.getAnnotationProcessors()) {
    ...
    static class ProcessorState {
        public javi.api.annotation.processing.Processor processor;
        ...
        ProcessorState(javi.api.annotation.processing.Processor p, Log log, Source source, DeferredCompletionFailureHandler dcfh,
                       boolean allowModules, javi.api.annotation.processing.ProcessingEnvironment env, boolean lint) {
            processor = p;
            contributed = false;
    ...
    class DiscoveredProcessors implements Iterable<ProcessorState> {
        ...
        class ProcessorStateIterator implements Iterator<ProcessorState> {
             ...
             * annotations.
             */
            public void runContributingProcs(javi.api.annotation.processing.RoundEnvironment re) {
                if (!onProcIterator) {
        ...
        DiscoveredProcessors(Iterator<? extends javi.api.annotation.processing.Processor> processorIterator) {
    ...
    private void discoverAndRunProcs(Set<TypeElement> annotationsPresent,
        ...
        javi.api.annotation.processing.RoundEnvironment renv = new JavacRoundEnvironment(false,
                                                          false,
                                                          rootElements,
                                                          JavacProcessingEnvironment.this);
    ...
    private boolean callProcessor(javi.api.annotation.processing.Processor proc,
                                  Set<? extends TypeElement> tes,
                                  javi.api.annotation.processing.RoundEnvironment renv) {
        Handler prevDeferredHandler = dcfh.setHandler(dcfh.userCodeHandler);
        try {
        ...
        void run(boolean lastRound, boolean errorStatus) {
            ...
            try {
                if (lastRound) {
                    ...
                    javi.api.annotation.processing.RoundEnvironment renv = new JavacRoundEnvironment(true,
                            errorStatus,
                            emptyRootElements,
                            JavacProcessingEnvironment.this);
    ...
    private boolean needClassLoader(String procNames, Iterable<? extends Path> workingpath) {
        ...
        for(Path pathElement : workingpath) {
            try {
                ...
                if (ServiceProxy.hasService(javi.api.annotation.processing.Processor.class, urls))
                    return true;
    ...
    @DefinedBy(Api.ANNOTATION_PROCESSING)
    public javi.api.annotation.processing.Messager getMessager() {
        return messager;
    }
     ...
     */
    private static Pattern importStringToPattern(boolean allowModules, String s, javi.api.annotation.processing.Processor p, Log log, boolean lint) {
        String module;
        String pkg;
        int slash = s.indexOf('/');
        if (slash == (-1)) {
