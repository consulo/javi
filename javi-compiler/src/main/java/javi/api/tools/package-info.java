 ...
 * ({@link javi.api.tools.DiagnosticListener}) as well as a file
 * abstraction for overriding file access ({@link
 * javi.api.tools.JavaFileManager} and {@link
 * javi.api.tools.JavaFileObject}).  See {@link
 * javi.api.tools.JavaCompiler} for more details on using the SPI.
 *
 * <p>There is no requirement for a compiler at runtime.  However, if
 * a default compiler is provided, it can be located using the
 * {@link javi.api.tools.ToolProvider}, for example:
 *
