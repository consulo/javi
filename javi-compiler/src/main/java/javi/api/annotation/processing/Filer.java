...
package javi.api.annotation.processing;
 ...
 * javi.api.tools.StandardLocation#SOURCE_OUTPUT new source files}, and
 * one for {@linkplain javi.api.tools.StandardLocation#CLASS_OUTPUT new
...
public interface Filer {
     ...
     * javi.api.tools.StandardLocation#SOURCE_OUTPUT root output location for source
     ...
     */
    javi.api.tools.JavaFileObject createSourceFile(CharSequence name,
     ...
     *
     * The file's name and path (relative to the {@linkplain
     * javi.api.tools.StandardLocation#CLASS_OUTPUT root output location for class
     ...
     * @throws IOException if the file cannot be created
     */
    javi.api.tools.JavaFileObject createClassFile(CharSequence name,
                                                  Element... originatingElements) throws IOException;
     ...
     * javi.api.tools.StandardLocation#CLASS_OUTPUT CLASS_OUTPUT} and {@link
     * javi.api.tools.StandardLocation#SOURCE_OUTPUT SOURCE_OUTPUT} must be
     ...
     */
   javi.api.tools.FileObject createResource(JavaFileManager.Location location,
     ...
     * locations {@link javi.api.tools.StandardLocation#CLASS_OUTPUT CLASS_OUTPUT}
     * and {@link javi.api.tools.StandardLocation#SOURCE_OUTPUT SOURCE_OUTPUT} must
     * be supported.
     *
